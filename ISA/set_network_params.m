function params = set_network_params(paramsIN)

%% number of layers
params.num_isa_layers = 2;

%% fovea sizes
fovea{1}.spatial_size = paramsIN(1);
fovea{1}.temporal_size = paramsIN(1);

fovea{2}.spatial_size = paramsIN(2);
fovea{2}.temporal_size = paramsIN(2);
...
params.pca_dim_l1 = 200; % number of feature dimensions network layer 1
params.group_size_l1 = 1; % group size

params.pca_dim_l2 = 150; 
params.group_size_l2 = 4; 
